...
class InputServiceApp extends StatefulWidget {
  const InputServiceApp({Key? key, this.animationController}) : super(key: key);
  final AnimationController? animationController;
  @override
  // ignore: library_private_types_in_public_api
  _InputServiceAppState createState() => _InputServiceAppState();
}

class _InputServiceAppState extends State<InputServiceApp>
